...
The fee is calculated based on $1,800 USD, with deductions made according to the delay compensation clause in Article 6.
...
5.1 During development, the copyright of all source code for the System shall be temporarily held by the Developer.

5.2 Upon full settlement of the third installment specified in Article 4, all economic rights of the copyright relating to the System's source code shall be fully transferred to the Client, and the Developer shall no longer claim any intellectual property rights.
